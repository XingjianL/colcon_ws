...
do
    ...
    RCUTILS_LOGGING_USE_ROSOUT=1 RCUTILS_LOGGING_BUFFERED_STREAM=1 ros2 run tomato_xarm6 tomato_xarm6 -- --reset-time --light-temp 0,0,1 --both --seed 508 --disease-filter 2 --split-height-leaf 300,16 --preprocess Lab --percent-healthy 0.1
    kill -9 $(pgrep tomato_xarm6)
done
