#include "ur10_double_moveit/ur10.hpp"
#include "tf2/LinearMath/Quaternion.h"

ur10_double::UR10::UR10(const std::string& position_csv, const std::string& orientation_csv)
{
    load_robot_setpoints(position_csv, orientation_csv);
}

ur10_double::UR10::UR10(const std::string& robot_name, const std::string& position_csv, const std::string& orientation_csv)
{
    robot_name_ = robot_name;
    load_robot_setpoints(position_csv, orientation_csv);
}
ur10_double::UR10::UR10(const std::string &robot_name, rclcpp::Node::SharedPtr node)
{
    robot_name_ = robot_name;
...
ur10_double::UR10::~UR10()
{

}

void ur10_double::UR10::load_robot_setpoints(const std::string& position_csv, const std::string& orientation_csv)
{
    robot_setpoints_ = ur10_double::read_robot_setpoints(position_csv, orientation_csv);
}

void ur10_double::UR10::setpoint_control()
{
...
void ur10_double::UR10::configure_move_group(){
...
ur10_double::setpoints ur10_double::UR10::next_setpoint()
{
